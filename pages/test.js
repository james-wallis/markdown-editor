    ...
    <Modal
        title={
            (
                <div>
                    <p className="title">
                        <span>Claim: Coronavirus is less deadly than the flu</span>
                        {/* <span className="google-search"> Search this claim on Google</span> */}
                    </p>
                    <p className="percentage">75% of sources disagree</p>
                </div>
            )
        }
        visible
    ...
    >
        <div className="disagree">
            ...
            <div className="source">
                <a className="article">Critics said the flu kills more than coronavirus. Why that&apos;s not a fair comparison -- and now, it&apos;s not even true</a>
                <p className="author">CNN</p>
            </div>
            {/* <div className="source">
                <a className="article">Can a face mask protect me from coronavirus? Covid-19 myths busted</a>
